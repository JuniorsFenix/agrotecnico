		...
		<div class="row">
			<div class="col-md-6" style="display: flex; flex-direction: column; justify-content: flex-start;">
				<div class="info-producto">
                    ...
                    <?php if($rxProducto["inventario"]==0 ){?>
                      <h3 class="clear" style="color:black;font-weight: bold;">Agotado</h3>
                    <?php } else{ ?>
                ...
                <span>
                  COP <?php
                      if(DIASINIVA AND $rxProducto["diasiniva"]) {
                          ...
                          echo number_format( ($rxProducto["precio"]/$divisor), 0, ',', '.' );
                        }else{
            ...
            <div class="botonCarro">
                <div class="productPriceWrapRight cesta">
                    <span><input type="number" id="cantidad" name="cantidad" min="1" max="<?=$rxProducto["inventario"]?>" value="1" ></span><a style="line-height: 1;" href="<?php echo $home; ?>/php/inc/functions.php?action=addToBasket&productID=<?=$rxProducto["idproducto"];?>" id="featuredProduct_<?=$rxProducto["idproducto"];?>" class="1" onClick="return false;">
            ...
            <a class="botonmodal" onclick='abrirModal(1)'>
              ¿Cómo comprar?
				...
				<div class="add-wishlist"><a href="#" class="openmodal" data-url="<?php echo $url; ?>"><i class='fa fa-heart text-danger'></i> Añadir a lista de deseos</a></div>
			</div>
		</div>
          <div class="usos" >
