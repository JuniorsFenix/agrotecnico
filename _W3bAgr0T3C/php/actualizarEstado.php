<?php  
  // https://agrotecnico.com.co/actualizar-orden?test=1&pedido=Agrotecnico00615CO
  ...
  /* https://legatto.fenixpuntonet.info/actualizar-orden?test=1 */
  /* EFP Test PAYU */
  if($_GET["test"] == 1) {
    $_POST["response_code_pol"] = "1";
    $_POST["phone"] = "32130";
    $_POST["additional_value"] = "0.00";
    $_POST["test"] = "1";
    $_POST["transaction_date"] = "2019-09-16 13:17:28";
    $_POST["cc_number"] = "************1111";
    $_POST["cc_holder"] = "APPROVED";
    $_POST["error_code_bank"] = "";
    $_POST["billing_country"] = "CO";
    $_POST["bank_referenced_name"] = "";
    $_POST["description"] = "Pedido Legatto Fashion";
    $_POST["administrative_fee_tax"] = "0.00";
    $_POST["value"] = "65000.00";
    $_POST["administrative_fee"] = "0.00";
    $_POST["payment_method_type"] = "2";
    $_POST["office_phone"] = "";
    $_POST["account_id"] = "512321";
    $_POST["email_buyer"] = "edgarfranco01@gmail.com";
    $_POST["response_message_pol"] = "APPROVED";
    $_POST["error_message_bank"] = "";
    $_POST["shipping_city"] = "";
    $_POST["transaction_id"] = "853c42a7-1479-438b-ad9f-eb5085ebeb49";
    $_POST["sign"] = "91ee41c18f35e7ec7aa4a4773ecf4500";
    $_POST["operation_date"] = "2019-09-16 13:17:28";
    $_POST["tax"] = "0.00";
    $_POST["transaction_bank_id"] = "00000000";
    $_POST["payment_method"] = "10";
    $_POST["billing_address"] = "";
    $_POST["payment_method_name"] = "VISA";
    $_POST["pseCycle"] = "null";
    $_POST["pse_bank"] = "";
    $_POST["state_pol"]="4";
    $_POST["date"] = "2019.09.16 01:17:28";
    $_POST["nickname_buyer"] = "";
    $_POST["reference_pol"] = "846545876";
    $_POST["currency"] = "COP";
    $_POST["risk"] = "0.0";
    $_POST["shipping_address"] = "";
    $_POST["bank_id"] = "10";
    $_POST["payment_request_state"] = "A";
    $_POST["customer_number"] = "";
    $_POST["administrative_fee_base"] = "0.00";
    $_POST["attempts"] = "1";
    $_POST["merchant_id"] = "508029";
    $_POST["exchange_rate"] = "1.00";
    $_POST["shipping_country"] = "CO";
    $_POST["installments_number"] = "1";
    $_POST["franchise"] = "VISA";
    $_POST["payment_method_id"] = "2";
    $_POST["extra1"] = "";
    $_POST["extra2"] = "";
    $_POST["antifraudMerchantId"] = "";
    $_POST["extra3"] = "";
    $_POST["commision_pol_currency"] = "";
    $_POST["nickname_seller"] = "";
    $_POST["ip"] = "172.18.49.47";
    $_POST["commision_pol"] = "0.00";
    $_POST["airline_code"] = "";
    $_POST["billing_city"] = "";
    $_POST["pse_reference1"] = "";
    $_POST["cus"] = "00000000";
    $_POST["authorization_code"] = "00000000";
    $_POST["pse_reference3"] = "";
    $_POST["pse_reference2"] = "";
    
    /* debe ser una referenciaPayu valida que se encuentre en tblti_carro */
    $_POST["reference_sale"] = "Dekorare00205US";
    $_POST["reference_sale"] = "Dekorare00204CO";
    
    $_POST["reference_sale"] = $_GET["pedido"];    
  }


  if(!session_id()) session_start();
  $_SESSION["pais"] = substr($_POST["reference_sale"],-2);
  ...
  if($_SESSION["pais"] != "CO"){
	...
	$d = $_POST;
			...
			else if ($d['state_pol'] == 6 ) {
				$estado = "Rechazada";
			}
			
			else if ($d['state_pol'] == 104 ) {
				$estado = "Error";
			}
			
			else if ($d['state_pol'] == 7 ) {
				$estado = "Pendiente";
			}
			
			if ($d['payment_method_id'] == 2 ) {
				$pago = "Tarjeta de Crédito";
			}
			
			else if ($d['payment_method_id'] == 4 ) {
				$pago = "PSE";
			}
			
			else if ($d['payment_method_id'] == 6 ) {
				$pago = "Tarjeta de débito";
			}
			
			else if ($d['payment_method_id'] == 10 ) {
				$pago = "Pago en banco";
      }
  
      $idtransaccion = "PAYU " . $_POST["transaction_id"];

		$sql="UPDATE tblti_carro SET estado = '$estado', response = '{$d["response_message_pol"]}', medio = '$pago' , idtransaccion = '$idtransaccion' WHERE referenciaPayU = '{$d["reference_sale"]}'";	
		$r = mysqli_query($nConexion,$sql);	

if ($estado == 'Aprobada') {

  $query = "select * from tblti_carro where referenciaPayU = '{$d["reference_sale"]}'";
  ...
  if ($row = mysqli_fetch_row($result)) {
	...
	$sinIva=$pedido["precio_total"] / 1.19;
	$iva=$sinIva*.19;
		...
		<table class="productos" style="border:1px solid black;" cellspacing="0" width="100%" cellpadding="6">
			<thead>
				<tr>
					...
					<th style="width:100px;text-align:center;"><?php echo mb_strtoupper(("IVA (19%)"));?></th>
...
*/
          ...
          if($_SESSION["pais"] == "CO"){
            ...
            <?php
              if(DIASINIVA AND $row["diasiniva"]) {
                ...
                $i = $row["precio"] - round($row["precio"]/1.19);
              }
              $totaliva += $i;
    ...
    Referencia de pago (PAYU): <?=$d["reference_sale"]?>
...
//var_dump($mail);
  ...
  <?php if( $_SESSION["pais"] == "CO" && $impuesto ){ ?>
    ...
    ?>
    Referencia de pago (PAYU): <?=$d["reference_sale"]?><br>
    <?=$mensaje?>
