<?php
/**
 * https://github.com/saulmoralespa/coordinadora-webservice-php
 *
 * Created by PhpStorm.
 * User: smp
 * Date: 27/01/19
...
class WebService
{
    ...
    {
        return json_encode(self::call_soap(__FUNCTION__));
    ...
    public function Cotizador_cotizar($params)
    {
        ...
        return json_encode($this->call_soap(__FUNCTION__, $body));
    }
