<?
  ...
  @ $exists = mysqli_query($nConexion,"SELECT 1 FROM tblradioblog LIMIT 0");

  if(!$exists){

    $sql="

      CREATE TABLE `tblradioblog` (
  ...
  $page=new sistema_paginacion('tblradioblog');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="8" align="center" class="tituloFormulario">
          ...
          <b>LISTA DE MUSICA PARA RADIOBLOG</b>
