<?
	...
	include("productos_categorias_funciones.php");
	...
	{
	header("Location: productos_categorias_listar.php");
	}
?>
<html>
	<head>
		<title>Administraci�n de Categor�as - Modulo Glosario</title>
  ...
  */
    switch($_GET["Accion"])
    {
      ...
      case "Guardar":
        ...
        //$folder = "../imguser/categoriasprod/";
				$folder = $cRutaImgCategorias_Productos;
