<?
	...
	$page=new sistema_paginacion('tblproductosplus');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="5" align="center" class="tituloFormulario">
          ...
          <b>LISTA DE OPCIONES - PRODUCTOS</b>
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>" align="center">
						...
						<a href="productos_opplus.php?Accion=Editar&Id=<? echo "$row->id"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->producto"; ?>"></a>&nbsp;

						<a href="productos_opciones_listar.php?&Id=<? echo "$row->id"; ?>&nom=<?=$row->descripcion;?>"><img src="../../image/versubcat.gif" border="0" alt="Ver Opciones"></a>
      ...
      <tr>
        ...
        <td colspan="5" class="nuevo">
          ...
          <a href="productos_opplus.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
