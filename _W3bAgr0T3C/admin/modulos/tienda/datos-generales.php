...
require_once '../../herramientas/paginar/dbquery.inc.php';
    ...
    if (isset( $_POST["titulo"] )) {
        ...
        $ca->prepareUpdate("tbldatos_generales", "titulo_productos,descripcion_productos,palabras_productos");

        $ca->bindValue(":titulo_productos", $titulo, true);

        $ca->bindValue(":descripcion_productos", $descripcion, true);

        $ca->bindValue(":palabras_productos", $palabras, true);
...
<?php include("../../system_menu.php"); ?><br>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr valign="baseline">
        ...
        <td class="contenidoNombres"><input type="text" name="titulo" size="50" value="<?php echo $r["titulo_productos"] ?>"></td>
      ...
      <tr valign="baseline">
        ...
        <td class="contenidoNombres"><textarea cols="38" name="descripcion"><?php echo $r["descripcion_productos"] ?></textarea></td>
      ...
      <tr valign="baseline">
        ...
        <td class="contenidoNombres"><textarea cols="38" name="palabras"><?php echo $r["palabras_productos"] ?></textarea></td>
