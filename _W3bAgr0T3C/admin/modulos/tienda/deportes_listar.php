<?
  ...
  $page = new sistema_paginacion('tblti_deportes');
  ...
  if ( !$rsCabezotes ) {
    ...
    die ( "Fallo consultando deportes" );
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="deportes_listar.php" method="post">
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="deportes.php?Accion=Editar&Id=<?=$row->id?>">

	    <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->nombre;?>"></a></td>

	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="deportes.php?Accion=Eliminar&Id=<?=$row->id;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="deportes.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
