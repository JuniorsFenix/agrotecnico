<?
  ...
  $page=new sistema_paginacion('tblboletinesprensa');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="boletines_listar.php" method="get">

    <table border="0" width="100%" cellspacing="0" cellpadding="0">

      <tr>

        <td>Buscar Boletín:</td>
	...
	?>
	  ...
	  <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->publicar"; ?></td>
          ...
          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="boletines.php?Accion=Editar&Id=<? echo "$row->idboletin"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->nombre"; ?>"></a></td>
	  ...
	  if ( !empty( $row->imagen ) ) {
		  ...
		  ?><a href="<?php echo $cRutaVerImgBoletines . $row->imagen; ?>" target="_blank">Ver</a><?
