<?
  ...
  $page=new sistema_paginacion('tblfiltropalabras');

  $page->ordenar_por('palabra desc');
  ...
  <? include("../../system_menu.php"); ?><br>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td bgcolor="#FEF1E2"><b>Palabra</b></td>
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->idfiltro"; ?></td>

          <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->palabra"; ?></td>

          <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="filtros.php?Accion=Editar&Id=<? echo "$row->idfiltro"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->idfiltro"; ?>"></a></td>
      ...
      <tr>
        ...
        <td colspan="5" class="nuevo">
          ...
          <a href="filtros.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
