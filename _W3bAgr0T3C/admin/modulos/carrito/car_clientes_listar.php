<?
  ...
  $page=new sistema_paginacion('tbl_cart_clientes');

	$page->set_condicion( "WHERE idciudad = ". $IdCiudad );

  $page->ordenar_por('apellidos, nombres');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo $row->nombres; ?></td>
					...
					<td bgcolor="<? echo $ColorFila; ?>" align="center">
						...
						<a href="car_clientes.php?Accion=Editar&Id=<? echo "$row->idcliente"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar"></a>

						&nbsp;

						<a href="car_verpedido_cli.php?nombre=<? echo $row->nombres." ".$row->apellidos; ?>&idcliente=<? echo "$row->idcliente"; ?>"><img src="../../image/pedidos.gif" border="0" alt="Ver Pedidos: <? echo $row->nombres . " " . $row->apellidos ;?>"></a>
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="car_clientes.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
