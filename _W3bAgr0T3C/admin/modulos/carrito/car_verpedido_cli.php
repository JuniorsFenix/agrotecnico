    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="5" align="center" class="tituloFormulario">
          ...
          <b>LISTA DE PEDIDOS</b><br>Cliente: <? echo $_GET["nombre"]; ?>
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo number_format($row->neto,2,'.',','); ?></td>
					...
					<td bgcolor="<? echo $ColorFila; ?>" align="center">
						...
						<a href="car_verpedido_detalle.php?Id=<? echo "$row->idpedido"; ?>"><img src="../../image/pedidos.gif" border="0" alt="Ver Detalle Pedido No: <? echo $row->idpedido; ?> "></a>
