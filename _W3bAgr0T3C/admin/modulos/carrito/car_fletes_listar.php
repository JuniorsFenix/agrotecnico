<?
  ...
  $page=new sistema_paginacion('tbl_cart_fletes');

	$page->set_condicion( "WHERE idciudad = ". $IdCiudad );

  $page->ordenar_por('titulo');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo $row->idflete; ?></td>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo number_format($row->precio,2,'.',','); ?></td>
					...
					<a href="car_fletes.php?Accion=Editar&Id=<? echo "$row->idflete"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar"></a>
      ...
      <tr>
        ...
        <td colspan="4" class="nuevo">
          ...
          <a href="car_fletes.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
