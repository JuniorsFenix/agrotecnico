...
$page = new sistema_paginacion('tblsitio');
$page->set_limite_pagina(20);
$rs_sitio = $page->obtener_consulta();
...
<? include("../../system_menu.php"); ?><br>
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td bgcolor="#FEF1E2"><b>Latitud</b></td>
      ...
      <?php
        ...
        while( $row = mysqli_fetch_object( $rs_sitio ) )
        {
        ...
        <tr>
            ...
            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->latitud"; ?></td>
            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->longitud"; ?></td>
            <td bgcolor="<? echo $ColorFila; ?>"align="center">
                <a href="sitio.php?Accion=Editar">
