...
<link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
    ...
    <title>Editar archivo - <?php echo $sitioCfg["titulo"]; ?></title>
...
<body>
    ...
    <div id="container-inside">
        ...
        <form method="post" action="/<?php echo $sitioCfg["carpeta"]; ?>/archivos-membresia" enctype="multipart/form-data">
            ...
            <a href="<?php echo "/$sitioCfg[carpeta]/fotos/archivos/$documento[archivo]"; ?>" target="_blank" /><?php echo $documento["archivo"]; ?></a>
