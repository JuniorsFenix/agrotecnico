...
<body>
    ...
    <div id="container-inside">
        ...
        <table class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
            	<?php
					...
					$imagen="No asignada";
					if (!empty($row['imagen'])) {
						$imagen="<img src='/$sitioCfg[carpeta]/fotos/documentos/$row[imagen]' alt='$row[titulo]' height='30px'/>";
					}
				?>
                <tr>
                    <td><?php echo $row['id_documento']; ?></td>
                    <td><?php echo "<a href='/$sitioCfg[carpeta]/documentos/$row[id_documento]'>$row[titulo]</a>"; ?></td>
                    <td><?php echo substr(strip_tags($row['documento']),0,150); ?></td>
                    <td><?php echo $imagen; ?></td>
                    <td><?php echo $activo; ?></td>
                    <td><a href="/<?php echo $sitioCfg["carpeta"]; ?>/editar-documento/<?php echo $row['id_documento']; ?>"><img src="/<?php echo $sitioCfg["carpeta"]; ?>/imagenes/editar.png" alt="Editar" width="16px"/></a></td>
                    <td><a class="eliminar" href="/<?php echo $sitioCfg["carpeta"]; ?>/eliminarDocumento/<?php echo $row['id_documento']; ?>"><img src="/<?php echo $sitioCfg["carpeta"]; ?>/imagenes/eliminar.png" alt="Eliminar" width="15px"/></a></td>
                </tr>
            	<?php
					}
				?>
        ...
        <a style="margin:11px auto; display:block; width:96px;" href="/<?php echo $sitioCfg["carpeta"]; ?>/nuevo-documento"><img src="/<?php echo $sitioCfg["carpeta"]; ?>/imagenes/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
    </div>
