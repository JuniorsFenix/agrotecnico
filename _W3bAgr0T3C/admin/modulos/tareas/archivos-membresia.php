<?php
	...
	if(isset($_POST["idcontenido"])){
		...
		header("Location: /$sitioCfg[carpeta]/archivos-membresia");
		exit;
	}
	...
	$documentos = contenidosMembresiasQuery("archivo");
?>
<!DOCTYPE html>
...
<link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
    ...
    <title>Archivos - <?php echo $sitioCfg["titulo"]; ?></title>
...
<body>
    ...
    <div id="container-inside">
            ...
            <tbody>
            	<?php
					...
					if (!empty($row['archivo'])) {
						$imagen="<a href='/$sitioCfg[carpeta]/fotos/archivos/$row[archivo]' alt='$row[nombre]' target='_blank'/>$row[archivo]</a>";
					}
				?>
                <tr>
                    ...
                    <td><a href="/<?php echo $sitioCfg["carpeta"]; ?>/editar-archivo-membresia/<?php echo $row['idcontenido']; ?>"><img src="/<?php echo $sitioCfg["carpeta"]; ?>/imagenes/editar.png" alt="Editar" width="16px"/></a></td>
        ...
        <a style="margin:11px auto; display:block; width:96px;" href="/<?php echo $sitioCfg["carpeta"]; ?>/nuevo-archivo-membresia"><img src="/<?php echo $sitioCfg["carpeta"]; ?>/imagenes/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
    </div>
