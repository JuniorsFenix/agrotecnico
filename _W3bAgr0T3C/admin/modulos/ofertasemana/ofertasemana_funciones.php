<?
  ...
  # ofertasemana_funciones.php  :  Archivo de funciones modulo noticias
...
<?
  ...
  function OfertasemanaFormNuevo()
...
?>
    ...
    <form method="post" action="ofertasemana.php?Accion=Guardar" enctype="multipart/form-data">
      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td colspan="2" align="center" class="tituloFormulario"><b>NUEVA OFERTA DE LA SEMANA</b></td>
        ...
        <tr>
          ...
          <td class="tituloNombres">Duracion Oferta:</td>

          <td class="contenidoNombres"><INPUT id="txtDuracion" type="text" name="txtDuracion" maxLength="255" style="WIDTH: 300px; HEIGHT: 22px"></td>
        ...
        <tr>
          ...
          <td colspan="2"  class="nuevo">
            ...
            <a href="ofertasemana_listar.php"><img src="../../image/cancelar.gif" border="0" alt="Cancelar y Regresar."></a>
...
<?
  ...
  #                 $nIdC, $cEmpresa, $cDescripcion, $cDuracion, $cFuente, $cImagen, $cPublicar
  ...
  function OfertasemanaGuardar( $nId,$cEmpresa,$cDescripcion,$cDuracion,$cFuente,$cImagen,$cPublicar )

  {
...

    {
      ...
      mysqli_query($nConexion,"INSERT INTO tblofertasemana ( empresa,descripcion,imagen,duracion,fuente,fechapub,publicar,idciudad ) VALUES ( '$cEmpresa','$cDescripcion','$cImagen','$cDuracion','$cFuente',Now(),'$cPublicar',$IdCiudad )");

			Log_System( "OFERTASASEMANA" , "NUEVO" , "EMPRESA: " . $cEmpresa );

      mysqli_close($nConexion);

      Mensaje( "El registro ha sido almacenado correctamente.", "ofertasemana_listar.php" ) ;
...

    {
...

      {
        ...
        mysqli_query($nConexion, "UPDATE tblofertasemana SET empresa = '$cEmpresa',descripcion = '$cDescripcion',imagen = '$cImagen',duracion = '$cDuracion',fuente = '$cFuente',publicar='$cPublicar' WHERE idofertasemana = '$nId'" );
...

      {
        ...
        mysqli_query($nConexion, "UPDATE tblofertasemana SET empresa = '$cEmpresa',descripcion = '$cDescripcion',duracion = '$cDuracion',fuente = '$cFuente',publicar='$cPublicar' WHERE idofertasemana = '$nId'" );

      }

			Log_System( "OFERTASASEMANA" , "EDITA" , "EMPRESA: " . $cEmpresa );

      mysqli_close( $nConexion );

      Mensaje( "El registro ha sido actualizado correctamente.", "ofertasemana_listar.php" ) ;
...
<?
  ...
  function OfertasemanaEliminar( $nId )

  {

    $nConexion = Conectar();

		$reg = mysqli_fetch_object( mysqli_query($nConexion,"SELECT empresa FROM tblofertasemana WHERE idofertasemana ='$nId'") );

    mysqli_query($nConexion, "DELETE FROM tblofertasemana WHERE idofertasemana ='$nId'" );

		Log_System( "OFERTASASEMANA" , "ELIMINA" , "EMPRESA: " . $reg->empresa  );

    mysqli_close( $nConexion );

    Mensaje( "El registro ha sido eliminado correctamente.","ofertasemana_listar.php" );
...
<?
  ...
  function OfertasemanaFormEditar( $nId )

  {
    ...
    $Resultado    = mysqli_query($nConexion, "SELECT * FROM tblofertasemana WHERE idofertasemana = '$nId'" ) ;
    ...
    <form method="post" action="ofertasemana.php?Accion=Guardar" enctype="multipart/form-data">
      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td colspan="2" align="center" class="tituloFormulario"><b>EDITAR OFERTA DE LA SEMANA</b></td>
        ...
        <tr>
          ...
          <td class="contenidoNombres"><INPUT id="txtDuracion" type="text" name="txtDuracion" value="<? echo $Registro["duracion"]; ?>" maxLength="255" style="WIDTH: 300px; HEIGHT: 22px"></td>
        ...
        <tr>
          ...
          <td colspan="2" class="nuevo">
            ...
            <input type="image" src="../../image/guardar.gif" alt="Guardar Registro.">
						...
						?><a href="ofertasemana.php?Accion=Eliminar&Id=<? echo $nId ;?>"><img src="../../image/eliminar.gif" border="0" alt="Eliminar Registro." onClick="javascript: return confirm('�Esta seguro que desea eliminar este registro?')"></a><?
