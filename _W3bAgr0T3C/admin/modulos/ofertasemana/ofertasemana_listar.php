<?
  ...
  $page=new sistema_paginacion('tblofertasemana');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="ofertasemana_listar.php" method="get">

    <table border="0" width="100%" cellspacing="0" cellpadding="0">

      <tr>

        <td>Buscar Oferta de la Semana:</td>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="5" align="center" class="tituloFormulario">
          ...
          <b>LISTA DE OFERTAS DE LA SEMANA</b>
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->empresa"; ?></td>

					<td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->publicar"; ?></td>

          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="ofertasemana.php?Accion=Editar&Id=<? echo "$row->idofertasemana"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->empresa"; ?>"></a></td>
...

					{
						...
						?><a href="<? echo $cRutaVerImgOfertasemana . $row->imagen; ?>" target="_blank">Ver</a><?
      ...
      <tr>
        ...
        <td colspan="5" class="nuevo">
          ...
          <a href="ofertasemana.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
