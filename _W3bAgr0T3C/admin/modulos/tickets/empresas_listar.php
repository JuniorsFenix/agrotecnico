...
$page = new sistema_paginacion('tbltk_empresas');



$page->ordenar_por('idempresa');

$page->set_limite_pagina(20);

$rsEmpresas = $page->obtener_consulta();

if (!$rsEmpresas) {

    die("Fallo consultando empresas");
...
<html>
    ...
    <body>
        ...
        <form action="empresas_listar.php" method="post"></form>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            while ($row = mysqli_fetch_object($rsEmpresas)) {
                ...
                <tr>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"><?php echo $row->idempresa; ?></td>

                    <td bgcolor="<?php echo $ColorFila; ?>"><?php echo $row->nombre; ?></td>

                    <td bgcolor="<?php echo $ColorFila; ?>" align="center"><a href="empresas.php?Accion=Editar&Id=<?php echo $row->idempresa;?>">

                            <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar"></a></td>

                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">

                        <a href="empresas.php?Accion=Eliminar&Id=<?php echo $row->idempresa;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
            ...
            <tr>
                ...
                <td colspan="6" class="nuevo">
                    ...
                    <a href="empresas.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."/></a>
