...
$page = new sistema_paginacion('tbltk_pevaluaciones');
...
<html>
    ...
    <body>
        ...
        <form action="p_evaluaciones_listar.php" method="post"></form>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            while ($row = mysqli_fetch_object($rsEvaluaciones)) {
                ...
                <tr>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>" align="center">
                        ...
                        <a href="p_evaluaciones.php?Accion=Editar&Id=<?php echo $row->idevaluacion;?>">
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">
                        ...
                        <a href="p_evaluaciones.php?Accion=Eliminar&Id=<?php echo $row->idevaluacion;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
            ...
            <tr>
                ...
                <td colspan="6" class="nuevo">
                    ...
                    <a href="p_evaluaciones.php?Accion=Adicionar">
