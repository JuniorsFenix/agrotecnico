...
if ( $filtro != "" ) {
    ...
    $where .= "and ( upper(b.nombre) like upper('%{$filtro}%') or upper(a.descripcion) like upper('%{$filtro}%') ) ";
...
$page = new sistema_paginacion('tbltk_pevaluaciones_det a join tbltk_pevaluaciones b on (a.idevaluacion=b.idevaluacion)');

$page->set_campos("a.idconcepto,a.descripcion,b.nombre as evaluacion");
    ...
    <body>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td bgcolor="#FEF1E2"><b>Preguntas</b></td>

                <td bgcolor="#FEF1E2"><b>Evaluaci�n</b></td>
            ...
            while ($row = mysqli_fetch_object($rsPreguntas)) {
                ...
                <tr>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"><?php echo $row->idconcepto; ?></td>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>" align="center">
                        ...
                        <a href="preguntas.php?Accion=Editar&Id=<?php echo $row->idconcepto;?>">
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">
                        ...
                        <a href="preguntas.php?Accion=Eliminar&Id=<?php echo $row->idconcepto;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
