<?
  ...
  $page=new sistema_paginacion('tblcinta_categorias');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="cabezotes_listar.php" method="post">
	...
	<td bgcolor="#FEF1E2"><b>Color de Fondo</b></td>

	<td bgcolor="#FEF1E2"><b>Ancho</b></td>

	<td bgcolor="#FEF1E2"><b>Alto</b></td>

	<!--<td bgcolor="#FEF1E2"><b>Margen</b></td>-->
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->background; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->width; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->height; ?></td>

	    <!--<td bgcolor="<? //echo $ColorFila; ?>"><? //$row->margen; ?></td>-->
