...
$page = new sistema_paginacion('tblmb_membresias a');



$page->set_campos("a.idmembresia,a.nombre");

$page->ordenar_por('a.idmembresia');

$page->set_limite_pagina(20);



$rsMembresias = $page->obtener_consulta();



if (!$rsMembresias) {

    die("Fallo consultando Membresias");
...
<html>
    ...
    <head>
        ...
        <title>Lista de Membresias</title>
...
<?php require_once("../../system_menu.php"); ?><br>
        ...
        <form action="membresias_listar.php" method="post"></form>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            while ($row = mysqli_fetch_object($rsMembresias)) {
                ...
                <tr>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"><?php echo $row->idmembresia; ?></td>

                    <td bgcolor="<?php echo $ColorFila; ?>"><?php echo $row->nombre; ?></td>

                    <td bgcolor="<?php echo $ColorFila; ?>" align="center">

                        <a href="membresias.php?Accion=Editar&Id=<?php echo $row->idmembresia; ?>">
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">
                        ...
                        <a href="membresias.php?Accion=Eliminar&Id=<?php echo $row->idmembresia; ?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
            ...
            <tr>
                ...
                <td colspan="6" class="nuevo">
                    ...
                    <a href="membresias.php?Accion=Adicionar">
