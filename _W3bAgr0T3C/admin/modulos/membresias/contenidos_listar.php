...
$page->set_condicion("where tipo='contenido'");
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="9" align="center" class="tituloFormulario">
                    ...
                    <b>LISTA DE CONTENIDOS MEMBRESIAS</b>
            ...
            while ($row = mysqli_fetch_object($rs_contenidos)) {
                ...
                <tr>
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">
                        ...
                        <a href="contenidos.php?Accion=Editar&Id=<?php echo $row->idcontenido;?>">
                    ...
                    <td bgcolor="<?php echo $ColorFila; ?>"align="center">
                        ...
                        if (!empty($row->imagen)) {
                            ...
                            echo "<img src=\"{$cRutaVerImgMbContenidos}{$row->imagen}\" width=\"50\"/>";

                            echo "<a href=\"{$cRutaVerImgMbContenidos}{$row->imagen}\" target=\"_blank\">Ver</a>";
