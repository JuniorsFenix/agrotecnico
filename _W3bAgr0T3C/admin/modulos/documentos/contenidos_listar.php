<?
  ...
  $page=new sistema_paginacion('tbldocumentos');
  ...
  $page->ordenar_por('idcontenido desc');
...
<? include("../../system_menu.php"); ?><br>
	...
	$ColorFilaImpar	= "#F0F0F0";
	  ...
	  <td bgcolor="<? echo $ColorFila; ?>">&nbsp;&nbsp;</td>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><?=$row->idcontenido;?></td>

          <td bgcolor="<? echo $ColorFila; ?>"><?=$row->titulo;?></td>

          <td bgcolor="<? echo $ColorFila; ?>"><? echo run_php2(stripslashes($row->descripcion));?></td>

          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="contenidos.php?Accion=Editar&Id=<?=$row->idcontenido;?>">

	  <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->idcontenido;?>"></a></td>

	  <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="contenidos.php?Accion=Eliminar&Id=<?=$row->idcontenido;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
