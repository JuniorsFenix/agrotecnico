<?
  ...
  $page=new sistema_paginacion('tbltarjetas');
  ...
  $page->ordenar_por('idtarjeta desc');
...
<? include("../../system_menu.php"); ?><br>
	...
	$ColorFilaImpar	= "#F0F0F0";
	  ...
	  <td bgcolor="<? echo $ColorFila; ?>">&nbsp;&nbsp;</td>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->idtarjeta"; ?></td>
	  ...
	  <td bgcolor="<? echo $ColorFila; ?>" align="center">
            ...
            <?
              ...
              if ( !empty($row->archivo) ) {
                ...
                ?><a target="_blank" href="<? echo $cRutaVerTarjetas . $row->archivo ; ?>">Ver</a>

		<img src="<? echo $cRutaVerTarjetas . $row->archivo; ?>" alt="" width="100" height="100" hspace="0" align="center" border="0" />
          ...
          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="tarjetas.php?Accion=Editar&Id=<? echo "$row->idtarjeta"; ?>">

	  <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->archivo"; ?>"></a></td>

          

	  <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="tarjetas.php?Accion=Eliminar&Id=<?=$row->idtarjeta;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="8" class="nuevo">
          ...
          <a href="tarjetas.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
