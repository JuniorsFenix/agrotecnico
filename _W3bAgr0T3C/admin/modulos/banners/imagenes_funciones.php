      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td class="contenidoNombres">
						...
						<?
            $nConexion = Conectar();
            $ResultadoCat = mysqli_query($nConexion, "SELECT * FROM tblcategoriasimagenes ORDER BY idcategoria" );
...
<?
  ...
  # Retorno       : Ninguno
  ###############################################################################
  function ImagenesGuardar( $nId,$nIdCategoria,$cDetalle,$cImagen,$cPublicar )
  {
    $nConexion = Conectar();
    if ( $nId <= 0 ) // Nuevo Registro
    {
      mysqli_query($nConexion,"INSERT INTO tblimagenes ( idcategoria,descripcion,imagen,publicar ) VALUES ( '$nIdCategoria','$cDetalle','$cImagen','$cPublicar' )");
