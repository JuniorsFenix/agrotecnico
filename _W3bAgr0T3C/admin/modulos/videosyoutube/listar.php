<?
  ...
  @ $exists = mysqli_query($nConexion,"SELECT 1 FROM tblvideosyoutube LIMIT 0");

  if(!$exists){

    $sql="

      CREATE TABLE `tblvideosyoutube` (
  ...
  $page=new sistema_paginacion('tblvideosyoutube');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="videos.php?Accion=Adicionar&idcategoria=<?php echo $_GET["idcategoria"];?>"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
