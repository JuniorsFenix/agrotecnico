  ...
  <form method="post" action="categorias.php?Accion=Guardar" enctype="multipart/form-data">
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <?php
        $ra =mysqli_query($nConexion,"select * from tblvideos_categorias order by vpath");
...
<?
  ...
  function CategoriasGuardar( $d )
  {
    ...
    {
      $sql="select vpath from tblvideos_categorias where idcategoria = {$d["IdCategoriaSuperior"]} ";
      ...
      $sql="insert into tblvideos_categorias
    ...
    else // Actualizar Registro Existente
    {
      ...
      $sql="select * from tblvideos_categorias where idcategoria = {$d["IdCategoria"]} ";
      $ra = mysqli_query($nConexion,$sql);
      $dCat = mysqli_fetch_assoc( $ra );

      $sql="update tblvideos_categorias set vpath=replace(vpath,'{$dCat["vpath"]}','{$vpath}')
      ...
      $sql="update tblvideos_categorias set idciudad={$_SESSION["IdCiudad"]},
...
<?
  ...
  function CategoriasEliminar( $idCategoria )
  {
    ...
    mysqli_query($nConexion, "DELETE FROM tblvideos_categorias WHERE idcategoria = $idCategoria " );
...
<?
  ...
  function CategoriasFormEditar( $idCategoria )
  {
    ...
    $nConexion    = Conectar();
    $Resultado    = mysqli_query($nConexion, "SELECT * FROM tblvideos_categorias where idcategoria = $idCategoria" ) ;
    ...
    <form method="post" action="categorias.php?Accion=Guardar" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <select name="IdCategoriaSuperior">
        <?php
        $ra =mysqli_query($nConexion,"select * from tblvideos_categorias  where idcategoria<>{$idCategoria} order by vpath");
        while( $rax=mysqli_fetch_object($ra) ){
