<?
  ...
  require_once("../../funciones_generales.php");
    ...
    CREATE TABLE `tblvideos_categorias` (
  ...
  $sql="select * from tblvideos_categorias where idcategoria = 0";

  $ra = mysqli_query($nConexion,$sql);

  if( mysqli_num_rows($ra) == 0 ){

    $sql="insert into tblvideos_categorias (idciudad,idcategoria,nombre,vpath,descripcion) values (1,-1,'--CATEGORIA PRINCIPAL--','/','')";

    $r = mysqli_query($nConexion, $sql);

    $sql="update tblvideos_categorias set idcategoria=0 where idcategoria=-1";
    ...
    $sql="alter table tblvideos add idcategoria integer";

    $r = mysqli_query($nConexion, $sql);



  $page=new sistema_paginacion('tblvideos_categorias');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="6" align="center" class="tituloFormulario">
          ...
          <b>LISTA DE CATEGORIAS DE VIDEOS</b>
