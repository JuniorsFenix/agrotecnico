<?
	...
	include("noticias_funciones.php");
...
<html>
	<head>
		<title>Administraci�n de Noticias</title>
  ...
  */
    switch($_GET["Accion"])
    {
      case  "Adicionar":
        ...
        break;
      case "Editar":
        NoticiasFormEditar($_GET["Id"]);
        break;
      case "Eliminar":
        NoticiasEliminar($_GET["Id"]);
        break;
      case "Guardar":
        ...
        if ( empty($Archivo) )
        {
          NoticiasGuardar($_POST["txtId"],$_POST["txtTitular"],$_POST["txtNoticia"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],"",$_POST["optPublicar"]);
          exit;
        }
        ...
        if(uploader($Campofile,$folder,$size,$tipos))
        {
          ...
          foreach ($uploader_archivos_copiados as $imagen => $detalles)
          {
            ...
            NoticiasGuardar($_POST["txtId"],$_POST["txtTitular"],$_POST["txtNoticia"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],$NomImagen,$_POST["optPublicar"]);
        }
        break;
      default:
        header("Location: noticias_listar.php");
