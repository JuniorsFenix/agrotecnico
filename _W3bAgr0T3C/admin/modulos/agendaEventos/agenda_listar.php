<?
  ...
  $page=new sistema_paginacion('tblreservaciones');
  ...
  $page->ordenar_por('idreservaciones desc');
...
<? include("../../system_menu.php"); ?><br>
	...
	$ColorFilaImpar	= "#F0F0F0";
	  ...
	  <td bgcolor="<? echo $ColorFila; ?>">&nbsp;&nbsp;</td>
          ...
          <td bgcolor="<? echo $ColorFila; ?>"><?=$row->idsalon;?></td>

		  <td bgcolor="<? echo $ColorFila; ?>"><?=$row->fecha;?></td>

		  <td bgcolor="<? echo $ColorFila; ?>"><?=$row->horario;?></td>

          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="agenda.php?Accion=Editar&Id=<?=$row->idreservaciones;?>">

	  <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->idreservaciones;?>"></a></td>

	  <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="frases.php?Accion=Eliminar&Id=<?=$row->idreservaciones;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="agenda.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
