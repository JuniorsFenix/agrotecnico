<?
  ...
  $page = new sistema_paginacion('tblestilos');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="cabezotes_listar.php" method="post">
	...
	<td bgcolor="#FEF1E2"><b>CSS</b></td>

	<td bgcolor="#FEF1E2"><b>Jquery</b></td>
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->css; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->jquery; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="estilos.php?Accion=Editar&Id=<?=$row->id;?>">

	    <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->archivo;?>"></a></td>

	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="estilos.php?Accion=Eliminar&Id=<?=$row->id;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="9" class="nuevo">
          ...
          <a href="estilos.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
