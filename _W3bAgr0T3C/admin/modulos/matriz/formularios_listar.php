<?php
	...
	$page->set_condicion( "WHERE post_type = 'wpcf7_contact_form'" );
...
<?php require_once("../../system_menu.php"); ?><br>
    <h1 class="tituloFormulario">LISTA DE FORMULARIOS</h1>
    <table class="display datatable" cellspacing="0" width="100%">
      ...
      <?php
        ...
        <tr>
            ...
            <td><a href="wp-admin/admin.php?page=wpcf7&post=<?php echo $row->ID; ?>&action=edit&wtlwp_token=84ade2f76256a66e1e0cc5a392dc5275"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?php echo $row->titulo; ?>"></a></td>
        </tr>
        <?php
        }
      ?>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <a href="wp-admin/admin.php?page=wpcf7-new&wtlwp_token=84ade2f76256a66e1e0cc5a392dc5275"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
                </td>
            </tr>
            <tr>
