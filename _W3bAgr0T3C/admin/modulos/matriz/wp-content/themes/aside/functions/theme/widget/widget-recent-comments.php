...
class WP_Widget_Recent_Comments_Excerpts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('recent-comments', 'UX Recent Comments', $widget_ops);
		$this->alt_option_name = 'widget_recent_comments';

		if ( is_active_widget(false, false, $this->id_base) )
			add_action( 'wp_head', array(&$this, 'recent_comments_style') );

		add_action( 'comment_post', array(&$this, 'widget_flush_cache') );
		add_action( 'transition_comment_status', array(&$this, 'widget_flush_cache') );
	}
