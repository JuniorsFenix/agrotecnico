<?php
	...
	else
	{
		...
		echo "<script language=\"javascript\">location.href='$home/$_SESSION[idioma]/pagina-no-encontrada'</script>";
		}
        ...
        <section class="contenidoInterno">
        	<div class="container">
            	<div class="col1">
                    ...
                    <form action="<?php echo "$home/$_SESSION[idioma]"; ?>/gracias-por-contactarnos" class="formulario3" enctype="multipart/form-data" method="post" onsubmit="return validate1(this)">
