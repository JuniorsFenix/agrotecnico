...
require_once '../../herramientas/paginar/dbquery.inc.php';
    ...
    if (isset( $_POST["titulo"] )) {
        ...
        $ca->prepareUpdate("tbldatos_generales", "titulo_matriz,descripcion_matriz,palabras_matriz");
        $ca->bindValue(":titulo_matriz", $titulo, true);
        $ca->bindValue(":descripcion_matriz", $descripcion, true);
        $ca->bindValue(":palabras_matriz", $palabras, true);
		$ca->exec();
    }
...
<?php include("../../system_menu.php"); ?><br>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr valign="baseline">
        ...
        <td class="contenidoNombres"><input type="text" name="titulo" size="50" value="<?php echo $r["titulo_matriz"] ?>"></td>
      </tr>
      <tr valign="baseline">
        <td class="tituloNombres" width="15%"><strong>Descripción:</strong></td>
        <td class="contenidoNombres"><textarea cols="38" name="descripcion"><?php echo $r["descripcion_matriz"] ?></textarea></td>
      </tr>
      <tr valign="baseline">
        <td class="tituloNombres" width="15%"><strong>Palabras Claves:</strong></td>
        <td class="contenidoNombres"><textarea cols="38" name="palabras"><?php echo $r["palabras_matriz"] ?></textarea></td>
      </tr>
      <tr valign="baseline">
