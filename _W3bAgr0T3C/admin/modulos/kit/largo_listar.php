<?
  ...
  $page = new sistema_paginacion('tblki_largo');
...
<? include("../../system_menu.php"); ?><br>
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="largo.php?Accion=Editar&Id=<?=$row->id?>">

	    <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->nombre;?>"></a></td>

	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="largo.php?Accion=Eliminar&Id=<?=$row->id;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="largo.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
