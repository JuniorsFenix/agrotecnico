<?
  ...
  $page = new sistema_paginacion('tblki_colores');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="colores_listar.php" method="post">
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><div style="width:15px; height:15px; background:#<?=$row->color; ?>; border:solid 1px #999999; border-radius:3px;"></div></td>

	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="colores.php?Accion=Editar&Id=<?=$row->id?>">

	    <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->nombre;?>"></a></td>

	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="colores.php?Accion=Eliminar&Id=<?=$row->id;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="7" class="nuevo">
          ...
          <a href="colores.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
