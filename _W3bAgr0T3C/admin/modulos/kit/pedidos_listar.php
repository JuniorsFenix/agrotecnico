<?
  ...
  $page = new sistema_paginacion('tblki_pedidos');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="imagenes_listar.php" method="post">
	...
	<td bgcolor="#FEF1E2"><b>Color</b></td>

    <td bgcolor="#FEF1E2"><b>Calibre</b></td>

    <td bgcolor="#FEF1E2"><b>Extremos</b></td>

	<td bgcolor="#FEF1E2"><b>Longitud</b></td>

    <td bgcolor="#FEF1E2"><b>Cantidad</b></td>

    <td bgcolor="#FEF1E2"><b>Cliente</b></td>
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->color; ?></td>

	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->calibre; ?></td>

	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->extremos; ?></td>

	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->logitud; ?></td>

	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->cantidad; ?></td>

	    <td bgcolor="<?php echo $ColorFila; ?>"><?=$row->cliente; ?></td>
	    ...
	    <td bgcolor="<?php echo $ColorFila; ?>"align="center"><a href="pedidos.php?Accion=Eliminar&Id=<?=$row->id;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
