<?
  ...
  $page = new sistema_paginacion('tblki_cuerdas');



  $page->ordenar_por('idcuerda');
...
<? include("../../system_menu.php"); ?><br>
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->idcuerda; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->nombre; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="cuerdas.php?Accion=Editar&Id=<?=$row->idcuerda?>">

	    <img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<?=$row->nombre;?>"></a></td>

	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="cuerdas.php?Accion=Eliminar&Id=<?=$row->idcuerda;?>" onClick="return confirm('�Seguro que desea eliminar este registro?');">
      ...
      <tr>
        ...
        <td colspan="6" class="nuevo">
          ...
          <a href="cuerdas.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
