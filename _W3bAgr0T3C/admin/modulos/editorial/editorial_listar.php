<?
  ...
  $page=new sistema_paginacion('tbleditorial');
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="editorial.php?Accion=Editar&Id=<? echo "$row->ideditorial"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->titulo"; ?>"></a></td>
...

					{
						...
						?><a href="<? echo $cRutaVerImgEditorial . $row->imagen; ?>" target="_blank">Ver</a><?
      ...
      <tr>
        ...
        <td colspan="5" class="nuevo">
          ...
          <a href="editorial.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
