<?
	...
	include("editorial_funciones.php");
	include("../../herramientas/upload/uploaderFunction.php");
	include("../../vargenerales.php");
	if (!isset ($_GET["Accion"])) // Si no se envio la accion muestro la lista
	{
	header("Location: editorial_listar.php");
	}
?>
<html>
	<head>
		<title>Administraci�n de INFORMACI�N</title>
  ...
  */
    switch($_GET["Accion"])
    {
      case  "Adicionar":
        ...
        break;
      case "Editar":
        EditorialFormEditar($_GET["Id"]);
        break;
      case "Eliminar":
        EditorialEliminar($_GET["Id"]);
        break;
      case "Guardar":
        ...
        if ( empty($Archivo) )
        {
          EditorialGuardar($_POST["txtId"],$_POST["txtTitulo"],$_POST["txtEditorial"],$_POST["txtCreditos"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],"",$_POST["optPublicar"]);
          exit;
        }
        ...
        if(uploader($Campofile,$folder,$size,$tipos))
        {
          ...
          foreach ($uploader_archivos_copiados as $imagen => $detalles)
          {
            ...
            EditorialGuardar($_POST["txtId"],$_POST["txtTitulo"],$_POST["txtEditorial"],$_POST["txtCreditos"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],$NomImagen,$_POST["optPublicar"]);
        }
        break;
      default:
        header("Location: editorial_listar.php");
