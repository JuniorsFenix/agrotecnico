<?
  ...
  $page=new sistema_paginacion('tblempsemana');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="empsemana_listar.php" method="get">

    <table border="0" width="100%" cellspacing="0" cellpadding="0">

      <tr>

        <td>Buscar Testimonio:</td>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <?
        ...
        <tr>
          ...
          <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="empsemana.php?Accion=Editar&Id=<? echo "$row->idempsemana"; ?>"><img src="../../image/seleccionar.gif" border="0" alt="Seleccionar:<? echo "$row->empresa"; ?>"></a></td>
...

					{
						...
						?><a href="<? echo $cRutaVerImgEmpsemana . $row->imagen; ?>" target="_blank">Ver</a><?
      ...
      <tr>
        ...
        <td colspan="5" class="nuevo">
          ...
          <a href="empsemana.php?Accion=Adicionar"><img src="../../image/nuevo.gif" border="0" alt="Crear Nuevo Registro."></a>
