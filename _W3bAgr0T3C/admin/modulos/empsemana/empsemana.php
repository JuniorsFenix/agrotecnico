<?
	...
	include("empsemana_funciones.php");
	include("../../herramientas/upload/uploaderFunction.php");
	include("../../vargenerales.php");
	if (!isset ($_GET["Accion"])) // Si no se envio la accion muestro la lista
	{
	header("Location: empsemana_listar.php");
	}
?>
<html>
	<head>
  ...
  */
    switch($_GET["Accion"])
    {
      case  "Adicionar":
        ...
        break;
      case "Editar":
        EmpsemanaFormEditar($_GET["Id"]);
        break;
      case "Eliminar":
        EmpsemanaEliminar($_GET["Id"]);
        break;
      case "Guardar":
        ...
        if ( empty($Archivo) )
        {
          EmpsemanaGuardar($_POST["txtId"],$_POST["txtEmpresa"],$_POST["txtDescripcion"],$_POST["txtFuente"],"",$_POST["optPublicar"]);
          exit;
        }
        ...
        if(uploader($Campofile,$folder,$size,$tipos))
        {
          ...
          foreach ($uploader_archivos_copiados as $imagen => $detalles)
          {
            ...
            EmpsemanaGuardar($_POST["txtId"],$_POST["txtEmpresa"],$_POST["txtDescripcion"],$_POST["txtFuente"],$NomImagen,$_POST["optPublicar"]);
        }
        break;
      default:
        header("Location: empsemana_listar.php");
