<?
  ...
  $page = new sistema_paginacion('tblcabezotesjq a join tblcabezotesjq_categorias b on (a.idcategoria=b.idcategoria)');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="cabezotes_listar.php" method="post">
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->idcabezote; ?></td>
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>" align="center"><a href="cabezotes.php?Accion=Editar&Id=<?=$row->idcabezote;?>">
	    ...
	    if ( !empty($row->archivo) ) {
	      ...
	      ?><a target="_blank" href="<?=$cRutaImgCabezotesjq.$row->archivo;?>">Ver</a>

	      <img src="<?=$cRutaImgCabezotesjq.$row->archivo;?>" alt="" width="100" height="100" hspace="0" align="center" border="0" />
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"align="center"><a href="cabezotes.php?Accion=Eliminar&Id=<?=$row->idcabezote;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
