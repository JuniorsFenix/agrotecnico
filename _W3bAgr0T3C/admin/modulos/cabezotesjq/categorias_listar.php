<?
  ...
  $page=new sistema_paginacion('tblcabezotesjq_categorias');
...
<? include("../../system_menu.php"); ?><br>
  ...
  <form action="cabezotes_listar.php" method="post">
	...
	<td bgcolor="#FEF1E2"><b>Tiras</b></td>

	<td bgcolor="#FEF1E2"><b>Duracion</b></td>

	<td bgcolor="#FEF1E2"><b>Posicion</b></td>

	<td bgcolor="#FEF1E2"><b>Direccion</b></td>

	<td bgcolor="#FEF1E2"><b>Navegacion</b></td>

	<td bgcolor="#FEF1E2"><b>Links</b></td>
	...
	$ColorFilaImpar	= "#F0F0F0";
	    ...
	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->effect; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->width; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->height; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->strips; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->delay; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->position; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->direction; ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->navigation=="1"?"Si":($row->navigation=="0"?"No":""); ?></td>

	    <td bgcolor="<? echo $ColorFila; ?>"><?=$row->links=="1"?"Si":($row->links=="0"?"No":""); ?></td>
