...
<?
	switch($_GET["Accion"]) {
		...
		break;
		case "Guardar":
			CategoriasGuardar($_POST["txtId"],$_POST["nombre"],$_POST["effect"],$_POST["width"],$_POST["height"],$_POST["strips"],
			$_POST["delay"],$_POST["stripDelay"],$_POST["titleOpacity"],$_POST["titleSpeed"],$_POST["position"],$_POST["direction"],
			$_POST["navigation"],$_POST["links"]);
		break;
		default:
			header("Location: categorias_listar.php");
			break;
