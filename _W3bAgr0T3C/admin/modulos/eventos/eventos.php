  ...
  */
    switch($_GET["Accion"])
    {
      case  "Adicionar":
        ...
        break;
      case "Editar":
        EventosFormEditar($_GET["Id"]);
        break;
      case "Eliminar":
        EventosEliminar($_GET["Id"]);
        break;
      case "Guardar":
        ...
        if ( empty($Archivo) )
        {
          EventosGuardar($_POST["txtId"],$_POST["txtEvento"],$_POST["txtDetalle"],$_POST["txtFechaHoraIni"],$_POST["txtPais"],$_POST["txtCiudad"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],"",$_POST["optPublicar"]);
          exit;
        }
          ...
          foreach ($uploader_archivos_copiados as $imagen => $detalles)
          {
            ...
            # $imagen que almacena los nombres de las imagenes
      	    ...
      	    # mysqli_query($nConexion,"Insert into tabla (imagen,tipo,size) values (".$imagen.",".$detalles[0].",".$detalles[1].")",$coneccion);
						...
						EventosGuardar($_POST["txtId"],$_POST["txtEvento"],$_POST["txtDetalle"],$_POST["txtFechaHoraIni"],$_POST["txtPais"],$_POST["txtCiudad"],$_POST["txtFuente"],$_POST["txtTags"],$_POST["txtPalabras"],$NomImagen,$_POST["optPublicar"]);
        }
        break;
      default:
        header("Location: eventos_listar.php");
