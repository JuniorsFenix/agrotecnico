...
$page = new sistema_paginacion('tbldiremp_zonas');



$page->ordenar_por('nombre asc');
...
<html>
    ...
    <head>
        ...
        <title>Lista de Zonas de Directorio Empresarial</title>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="4" align="center" class="tituloFormulario">
                    ...
                    <b>LISTA DE ZONAS DE DIRECTORIO EMPRESARIAL</b>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->codigo_zona"; ?></td>

                            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->nombre"; ?></td>

                            <td bgcolor="<? echo $ColorFila; ?>" align="center">

                                <a href="diremp_zonas.php?Accion=Editar&Id=<? echo "$row->codigo_zona"; ?>">
                            ...
                            <td bgcolor="<? echo $ColorFila; ?>"align="center">
                                ...
                                <a href="diremp_zonas.php?Accion=Eliminar&Id=<?= $row->codigo_zona; ?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="nuevo">
                            ...
                            <a href="diremp_zonas.php?Accion=Adicionar">
