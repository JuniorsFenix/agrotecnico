...
$page = new sistema_paginacion('tbldiremp_categorias');
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="4" align="center" class="tituloFormulario">
                    ...
                    <b>LISTA DE CATEGORIAS DIRECTORIO EMPRESARIAL</b>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->codigo_categoria"; ?></td>

                            <td bgcolor="<? echo $ColorFila; ?>"><? echo "$row->nombre"; ?></td>

                            <td bgcolor="<? echo $ColorFila; ?>" align="center">

                                <a href="diremp_categorias.php?Accion=Editar&Id=<? echo "$row->codigo_categoria"; ?>">
                            ...
                            <td bgcolor="<? echo $ColorFila; ?>"align="center">
                                ...
                                <a href="diremp_categorias.php?Accion=Eliminar&Id=<?=$row->codigo_categoria;?>" onclick="return confirm('�Seguro que desea eliminar este registro?');">
...
?>
            ...
            <tr>
                ...
                <td colspan="4" class="nuevo">
                    ...
                    <a href="diremp_categorias.php?Accion=Adicionar">
