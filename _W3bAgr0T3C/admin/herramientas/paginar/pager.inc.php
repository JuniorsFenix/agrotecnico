...
class Pager {
    ...
    public static function htmlPager($pageCount, $currentPage,$pageVars="", $p=array()) {
        ...
        if ($currentPage < $pageCount) {
            $htmlNextPage = "<li class=\"jlib-pager-next\"><a href=\"pagina{$nextPage}\" >Siguiente &raquo;</a></li>";
            $htmlLastPage = "<li class=\"jlib-pager-last\"><a href=\"pagina{$pageCount}\" >P&aacute;gina final</a></li>";
        }

        if ($currentPage > 1) {
            $htmlPrevPage = "<li class=\"jlib-pager-prev\"><a href=\"pagina{$prevPage}\"> &laquo; Anterior</a></li>";
            $htmlFirstPage = "<li class=\"jlib-pager-firstt\"><a href=\"pagina1\" >P&aacute;gina inicial</a></li>";
        }
        ...
        $htmlGotoPage="<li class=\"goto-page\">Ir a la pagina:<input type=\"text\" onkeypress=\"if(event.keyCode==13) location=pagina+this.value;\"></li>";
        ...
        for ($i = $startAt; $i <= $endAt; $i++) {
            ...
            $html.="<li class=\"jlib-pager-page\"><a href=\"pagina{$i}\"  >{$i}</a></li>";
        }
